...
public class algoritma_merge_sort {
	 public static void MergeSort(int[] merge, int bagian1, int bagian2) {
		 int p = bagian2 - bagian1; 
		 if (p <= 1)
		 return;
		 int bagianTengah = bagian1 + p/2;
		 MergeSort(merge, bagian1, bagianTengah); 
		 MergeSort(merge, bagianTengah, bagian2);		 
 ...
 public static void main(String[] args) {
	 ...
	 for (i = 0; i < panjang; i++);
	 MergeSort(angka, 0, panjang);
	 System.out.println("Urutan Array setelah menggunakan Merge Sort : ");
	 for (i = 0; i < panjang; i++)
