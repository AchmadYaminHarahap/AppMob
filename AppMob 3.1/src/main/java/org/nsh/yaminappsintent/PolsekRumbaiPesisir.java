...
public class PolsekRumbaiPesisir extends ListActivity {
    ...
    private void tampilkanpilihan(String pilihan) {
        try {
            ...
            if (pilihan.equals("Call Center")) {
                ...
                String lokasikp = "https://goo.gl/maps/tyrH5Fwy8ygxHvr18";
                a = new Intent(Intent.ACTION_VIEW, Uri.parse(lokasikp));

            } else if (pilihan.equals("Website")) {
                String website = "Maaf saat ini belum memiliki website";
                a = new Intent(Intent.ACTION_VIEW, Uri.parse(website));

            } else if (pilihan.equals("Info di Google")) {
                a = new Intent(Intent.ACTION_WEB_SEARCH);
                a.putExtra(SearchManager.QUERY, "Polsek Rumbai Pesisir");
            }
