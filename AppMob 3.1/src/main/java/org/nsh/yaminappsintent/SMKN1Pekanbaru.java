...
public class SMKN1Pekanbaru extends ListActivity {
    ...
    private void tampilkanpilihan(String pilihan) {
        try {
            ...
            if (pilihan.equals("Call Center")) {
                ...
                String lokasiSekolah = "https://goo.gl/maps/fG9LpTAY9fDpYRo19";
                a = new Intent(Intent.ACTION_VIEW, Uri.parse(lokasiSekolah));

            } else if (pilihan.equals("Website")) {
                String website = "http://www.smkn1pekanbaru.sch.id/";
                a = new Intent(Intent.ACTION_VIEW, Uri.parse(website));

            } else if (pilihan.equals("Info di Google")) {
                a = new Intent(Intent.ACTION_WEB_SEARCH);
                a.putExtra(SearchManager.QUERY, "SMKN 1 Pekanbaru");
            }
