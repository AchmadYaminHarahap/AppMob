...
public class PausSwalayan extends ListActivity {
    ...
    private void tampilkanpilihan(String pilihan) {
        try {
            ...
            if (pilihan.equals("Call Center")) {
                ...
                String lokasiPasar = "https://goo.gl/maps/4n1dSsBvLe3kRDN2A";
                a = new Intent(Intent.ACTION_VIEW, Uri.parse(lokasiPasar));

            } else if (pilihan.equals("Website")) {
                String website = "https://www.instagram.com/explore/locations/1032614269/indonesia/pekanbaru/paus-swalayan/?hl=id";
                a = new Intent(Intent.ACTION_VIEW, Uri.parse(website));

            } else if (pilihan.equals("Info di Google")) {
                a = new Intent(Intent.ACTION_WEB_SEARCH);
                a.putExtra(SearchManager.QUERY, "Paus Swalayan");
            }
