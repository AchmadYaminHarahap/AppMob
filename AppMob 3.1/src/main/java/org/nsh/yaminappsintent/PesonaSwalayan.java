    ...
    private void tampilkanpilihan(String pilihan) {
        try {
            ...
            if (pilihan.equals("Call Center")) {
                String nomortel = "tel:0761 798485";
                ...
                String lokasiPasar = "https://goo.gl/maps/W73roYyzrKPnVCMq8";
                a = new Intent(Intent.ACTION_VIEW, Uri.parse(lokasiPasar));

            } else if (pilihan.equals("Website")) {
                String website = "https://www.instagram.com/explore/locations/751511176/indonesia/pekanbaru/pesona-swalayan-jlgaruda-sakti-panam-pekanbaru/?hl=id";
